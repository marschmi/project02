...
```{r abundPlot, echo = TRUE, message=FALSE, fig.align='center', fig.height=6, fig.width=6}
...
```{r log2fold_calc and oddsratio_plot}
...
```{r example data, fig.height = 10, fig.width=12, warning = FALSE, fig.align='center'}
